          ...
          >
            ...
            >
              ...
              <Switch
                ...
                thumbColor={isEnabledDivorsable ? "white" : "white"}
                ios_backgroundColor="#3e3e3e"
            ...
            >
              ...
              <Switch
                ...
                thumbColor={isEnabledAppSound ? "white" : "white"}
                ios_backgroundColor="#3e3e3e"
            ...
            >
              ...
              <TouchableOpacity onPress={() => setCheckIn(!checkIn)}>
                <View
                  style={{
                    height: 20,
                    width: 20,
                    borderRadius: 5,
                    borderWidth: 1,
                    borderColor: !checkIn ? "gray" : "#00B4BF",
                    alignItems: "center",
                  }}
                >
                  {checkIn && (
            ...
            >
              ...
              <TouchableOpacity onPress={() => setRatePlayer(!ratePlayer)}>
                <View
                  style={{
                    height: 20,
                    width: 20,
                    borderRadius: 5,
                    borderWidth: 1,
                    borderColor: !ratePlayer ? "gray" : "#00B4BF",
                    alignItems: "center",
                  }}
                >
                  {ratePlayer && (
            ...
            >
              ...
              <TouchableOpacity onPress={() => setRatGoelie(!rateGolie)}>
                <View
                  style={{
                    height: 20,
                    width: 20,
                    borderRadius: 5,
                    borderWidth: 1,
                    borderColor: !rateGolie ? "gray" : "#00B4BF",
                    alignItems: "center",
                  }}
                >
                  {rateGolie && (
            ...
            >
              ...
              <TouchableOpacity onPress={() => setGolieTip(!golieTip)}>
                <View
                  style={{
                    height: 20,
                    width: 20,
                    borderRadius: 5,
                    borderWidth: 1,
                    borderColor: !golieTip ? "gray" : "#00B4BF",
                    alignItems: "center",
                  }}
                >
                  {golieTip && (
