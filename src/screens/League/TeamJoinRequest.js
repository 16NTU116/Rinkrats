	...
	return (
		<View style={styles.container}>
			...
			>
				...
				>
					<AuthHeader title="Team joining request" />
					<View
						style={{
					...
					>
						<Image source={require("../../../assets/images/greenUsers.png")} />
						<Text
							style={{
								color: "white",
								fontSize: 14,
						...
						>
							Your request to join the Team has been sent. You’ll be notifed
							regarding the status update.
						</Text>
					</View>
