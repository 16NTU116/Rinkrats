  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        >
          <AuthHeader title="Reset Password" navigation={props.navigation} />
          <AuthText text="Set your new password" />
          ...
          <Ionicons
            ...
            color="gray"
            size={25}
            style={{ position: "absolute", right: 10, top: normalize(200) }}
          />
          ...
          <Ionicons
            ...
            color="gray"
            size={25}
            style={{ position: "absolute", right: 10, top: normalize(120) }}
          />
          <TextInput
            keyboardType="default"
            style={{
